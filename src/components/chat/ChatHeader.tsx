...
const ChatHeader: React.FC<ChatHeaderProps> = ({ selectedModel, onModelChange, chatTitle, conversationId, onUpdateTitle, isSidebarExpanded }) => {
  const { t } = useLanguage();
  ...
  return (
    <div className="fixed top-0 z-10 p-2 bg-white bg-opacity-95 shadow-md m-2 max-w-[300px] rounded-lg transition-all duration-300" style={{
      left: isSidebarExpanded ? '260px' : '60px'
    }}>
